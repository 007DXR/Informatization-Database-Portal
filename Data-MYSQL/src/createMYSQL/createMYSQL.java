...
public class createMYSQL
{
	...
	{
		String s1 = "CREATE TABLE Records(dataID integer not null PRIMARY key, "
		...
		String s2 = "CREATE TABLE FirstIndex(IndexID integer AUTO_INCREMENT PRIMARY key, "
				+ "IndexName varchar(30), IndexNumeration varchar(10))"; // id(指标id)，指标名称，指标编号
		String s3 = "CREATE TABLE SecondIndex(IndexID integer AUTO_INCREMENT PRIMARY key, "
				+ "IndexName varchar(30), IndexNumeration varchar(10))";
		String s4 = "CREATE TABLE ThirdIndex(IndexID integer AUTO_INCREMENT PRIMARY key, "
				+ "IndexName varchar(30), IndexNumeration varchar(10))";
		try
		{
